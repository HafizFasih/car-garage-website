...
export default function Page({ params }: { params: Params }) {
  ...
  useEffect(() => {
    switch (params.manufacture) {
      case "bmw":
        setCarArray(bmwCarData);
        setLogo("/bmw-logo1.png");
        break;
      case "bentley":
        setCarArray(bentleyCarData);
        setLogo("/bentley-logo1.png");
        break;
      case "ford":
        setCarArray(fordCarData);
        setLogo("/ford-logo1.png");
        break;
      case "mercedes":
        setCarArray(mercedesCarData);
        setLogo("/mercedes-logo1.png");
        break;
    }
  }, [params.manufacture]); 
